 ...
 */
public class AFuVideoView extends SurfaceView implements MediaPlayerControl {
	 ...
	 */
	public AFuVideoView(Context context) {
		super(context);
		initVideoView();
		// add by yangguangfu
	 ...
	 * 图的 XML 标签属性集合。
	 */
	public AFuVideoView(Context context, AttributeSet attrs) {
	 ...
	 */
	public AFuVideoView(Context context, AttributeSet attrs, int defStyle) {
