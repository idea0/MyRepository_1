...
public class MainActivity extends BaseActivity implements View.OnClickListener {
	...
	private SharedPreferencesUtils mPrefService;
...
//			setContentView(framelayout);
	...
	private void initialization() {
		...
		if(mPrefService==null){
			mPrefService = new SharedPreferencesUtils(this);
		}
		if(Constants.isChangleLocale){
			 SharedPreferencesUtils.changleLocale(this, mPrefService);
		 }
...
//			intent = new Intent("com.yangguangfu.videoplayer.ExitListenerReceiver");
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_MENU) {
			Toast.makeText(MainActivity.this, R.string.app_hint_msg, 0)
					.show();
			return true;
		}
