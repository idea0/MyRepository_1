...
public class HelpActivity extends BaseActivity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mHelpGoMainmenu = (Button) findViewById(R.id.help_gomainmenu);
		mHelpSuggest = (Button) findViewById(R.id.help_suggest);
		mHelpGoVersion = (ImageButton) findViewById(R.id.help_goversion);
